## Script (Python) "iol_beforeCreateDocument1"
...
msg: messaggio custom
redirect_to: PlominoForm o PlominoView o ...
event_args: argomenti da passare al metodo beforecreate_child
"""
...
if child_events:
    ...
    def getWhereToRedirect(redirect_to, using, **kwargs):
        """
        redirect_to: the name of the object (i.e. PlominoView or PlominoForm) in the plominoDatabase where to redirect
        using: an attribute (i.e. template, or script or method) of the object to use/execute
    ...
    def beforecreate_child(redirect_to='', using='', message=(), **kwargs):
        ...
        redirect_to: the name of the object (i.e. PlominoView or PlominoForm) in the plominoDatabase where to redirect
        using: an attribute (i.e. template, or script or method) of the object to use/execute
        message: a 2-tuple object containing the message and his class type (e.g. ("Indicazioni per l'utente", 'info'))
        kwargs: arguments to pass to the url as query string.
        """
