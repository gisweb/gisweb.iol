...
##parameters=codici_pagamenti, field_allegato='ricevuta_pagamento', field_dg='elenco_pagamenti'
...
def updateDatagrid(diz_pagamenti,diz_code_pagamenti, stato_pagamento, dg_exist, allegato):
